...
const SolutionCard = ({ image, title, desc, highlight }: { image: string; title: string; desc: string; highlight: string }) => (
  <div className="flex flex-col gap-8 w-[320px] group cursor-pointer">
    {/* 4:3 Thumbnail Box */}
    <div className="w-full aspect-[4/3] rounded-[20px] bg-white flex items-center justify-center p-6 shadow-[0_4px_24px_rgba(0,0,0,0.04)] transition-all duration-500 group-hover:shadow-[0_20px_48px_rgba(0,0,0,0.08)] group-hover:-translate-y-1.5 overflow-hidden">
      <motion.img
        src={image}
        alt={title}
          ...
          <div className="w-full flex flex-col lg:flex-row items-center relative">
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 w-full h-full scale-[1.2] lg:scale-[1.4] -translate-x-12">
                  <HeroFloatingTiles />
                </div>
              </motion.div>
            </motion.div>
