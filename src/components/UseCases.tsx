    ...
    <section id="use-cases" className="py-24 px-6 bg-[var(--color-surface)] border-b border-[var(--color-outline)]/10">
      <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center w-full">
                  <div className="order-2 md:order-1">
                      ...
                      <div className="flex items-center gap-2 mb-6">
                          ...
                          <ChevronRight className="text-[var(--color-outline)] ml-1" size={24} />
                      </div>
        ...
        <div className="mt-28 flex justify-center">
            <button className="border border-[var(--color-outline)] text-[var(--color-on-surface-variant)] px-12 py-3.5 rounded-full font-bold text-lg hover:bg-[var(--color-primary)] hover:text-[var(--color-on-primary)] hover:border-transparent transition-all flex items-center gap-2">
                AI Agent / Solution 더보기 <ChevronRight size={20} />
            </button>
        </div>
      </div>
    </section>
